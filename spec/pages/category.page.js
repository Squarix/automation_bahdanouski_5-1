...
class CategoryPage extends BasePage {
	constructor(driver) {
		...
		this.newReleaseSelector = By.xpath('.//div[@id=\'tab_select_NewReleases\']')
		this.gamesSelector = By.xpath('.//div[contains(@class, \'tab_content_ctn\')]//div[@id=\'NewReleasesTable\']//a[contains(@class, \'tab_item\')]')
